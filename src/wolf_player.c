...
/*   Updated: 2018/01/15 15:48:18 by acourtin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			wolf_player_loop(t_wolf *wolf_game)
{
	...
	{
		wolf_game->player.posx += (wolf_game->player.is_moving * PLAYER_SPEED * (int)(wolf_game->player.rotx * 10));
		wolf_game->player.posy += wolf_game->player.is_moving * PLAYER_SPEED * (int)(wolf_game->player.roty * 10);
	}
